...
## Formato de salida de la auditoría (Audit output format)

IMPORTANTE: El reporte de auditoría y todos los hallazgos deben generarse estrictamente en ESPAÑOL.

Al realizar una auditoría, estructura los hallazgos así:

```markdown
## Resultados de la auditoría

### Problemas críticos (X encontrados)
- **[Categoría]** Descripción del problema. Archivo: `ruta/al/archivo.js:123`
  - **Impacto:** Por qué es importante esto
  - **Solución:** Cambio de código específico o recomendación

### Prioridad alta (X encontrados)
...

### Resumen
- Rendimiento: X problemas (Y críticos)
- Accesibilidad: X problemas (Y críticos)
- SEO: X problemas
- Mejores prácticas: X problemas

### Prioridad recomendada
1. Primero corrige esto porque...
2. Luego aborda...
3. Finalmente optimiza...
```
